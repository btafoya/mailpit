...
Thank you for your interest in contributing to MailSandbox, your help is greatly appreciated! Please follow the guidelines below to ensure a smooth contribution process.


## Code of conduct

Please be respectful and considerate in all interactions. MailSandbox is open source and free of charge, however is the result of thousands of hours of work.


## Reporting issues and feature requests

If you find a bug or have a feature request, please [open an issue](https://github.com/axllent/mailsandbox/issues) and provide as much detail as possible. Pleas do not report security issues here (see below).
...
2. **Clone your fork**  
   ```bash
   git clone https://github.com/your-username/mailsandbox.git
   cd mailsandbox
   ```
